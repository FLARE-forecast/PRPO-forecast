...
download_neon_files <- function(siteID_neon, siteID, products, buoy_products){
        ...
        # Airtemp
        airtemp <- neonstore::neon_table(table = "SAAT_30min-basic", site = "PRPO") %>%
        ...
        # Radiation
        radiation <- neonstore::neon_table(table = "SLRNR_30min-basic", site = "PRPO") %>%
        ...
        # Humidity
        humidity <- neonstore::neon_table(table = "RH_30min-basic", site = "PRPO") %>% 
        ...
        # Precipitation
        precip  <- neonstore::neon_table(table = "SECPRE_30min-basic", site = "DCFS") %>%
        ...
        # Wind Speed
        windspeed <- neonstore::neon_table(table = "2DWSD_30min-basic", site = "PRPO")%>%  
        ...
        # Pressure
        pressure <- neonstore::neon_table(table = "BP_30min-basic", site = "PRPO") %>%
        ...
        # ----------------------------------------------------------------------------------------
        water_temp <- neonstore::neon_table(table = "TSD_30_min-basic", site = "PRPO")%>% 
        ...
        temp_profiles <- neonstore::neon_table(table = "dep_profileData-basic", site = "PRPO")%>%
        ...
        secchi <- neonstore::neon_table(table = "dep_secchi-basic", site = "PRPO") %>%
