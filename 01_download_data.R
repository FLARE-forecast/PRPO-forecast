...
if (file.exists(file.path(getwd(),"data",subDir))){
  Sys.setenv("NEONSTORE_DB" = "/Users/ryanmcclure/Documents/PRPO-forecast/data/neonstore/")
  Sys.setenv("NEONSTORE_HOME" = "/Users/ryanmcclure/Documents/PRPO-forecast/data/neonstore/")
  neonstore::neon_dir()
} else {
